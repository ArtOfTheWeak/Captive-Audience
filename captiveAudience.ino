...
/* Code for Captive Audience v.01 
 based on YourSunny https://yoursunny.com/t/2017/freewifi/
 */
...
setup()
{
  ...
  /*WIFI NAME */
  WiFi.softAP("#SpeakersUnicorner Home", nullptr, 1);
